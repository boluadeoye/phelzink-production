    ...
    <div id="contact" className="w-full flex flex-col">
      ...
      <section className="relative w-full py-24 md:py-32 flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 flex flex-col items-center text-center text-white px-6 w-full max-w-[1280px] mx-auto">
          <h2 className="text-[clamp(32px,6vw,48px)] font-black tracking-tighter leading-tight mb-6 drop-shadow-xl">
            Get In Touch
          </h2>
          <p className="text-[15px] md:text-[16px] font-medium text-white/80 max-w-[540px] leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col md:grid md:grid-cols-12 gap-y-16 md:gap-x-12 lg:gap-x-20">
            ...
            <div className="md:col-span-7 flex flex-col">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <button type="submit" disabled={status !== "idle"} className="group w-full h-[68px] bg-[#0C0608] text-white rounded-2xl text-[16px] flex items-center justify-center gap-3 hover:bg-[#222222] transition-all active:scale-[0.98] disabled:opacity-70 mt-2 font-bold">
                  {status === "idle" ? (
                    <>
                      <Send className="w-5 h-5 -rotate-12 -translate-y-[1px] group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
                      <span>Send Message</span>
                    </>
                  ) : status === "loading" ? "Sending..." : "Message Sent!"}
                </button>
              </form>
            </div>
          </div>
