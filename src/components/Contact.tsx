      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-12">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-y-20 lg:gap-x-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col w-full">
            ...
            {/* THE MONOLITH HEADER */}
            <h2 className="font-sans font-black text-[clamp(38px,6vw,52px)] text-[#111111] leading-[0.8] tracking-[-0.04em] mb-12">
            ...
            {/* THE MAP: FULL COLOR, GHOST-BUTTON ERADICATED */}
            <div className="relative w-full aspect-[4/3] lg:h-[340px] rounded-[32px] overflow-hidden bg-[#F3F4F6] shadow-sm border border-gray-100">
              <iframe 
              ...
              {/* Open in Maps Pill (Positioned to occlude Google's default UI) */}
              <div className="absolute top-2.5 left-2.5 z-20">
                <a 
                  href={googleMapsUrl} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="bg-white px-4 py-2.5 rounded-xl text-[13px] font-black text-[#111111] flex items-center gap-2 shadow-md hover:scale-105 transition-transform duration-300 font-sans"
                >
                  Open in Maps 
              ...
              <div className="absolute bottom-4 right-4 z-20">
                <button 
                  ...
                  className="bg-white w-12 h-12 rounded-xl flex items-center justify-center text-[#111111] shadow-md hover:scale-105 transition-transform duration-300"
                >
          ...
          <div className="lg:col-span-6 lg:col-start-7 flex flex-col w-full mt-16 lg:mt-0">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="name" className="text-[11px] font-bold text-[#111111]/60 uppercase tracking-[0.15em] font-sans pl-2">Your Name *</label>
                <input required type="text" id="name" name="name" placeholder="Enter your name" className="w-full h-[64px] px-6 rounded-[24px] bg-[#F3F4F6] border border-transparent focus:border-[#111111] focus:bg-white outline-none font-sans text-[15px] font-medium transition-all placeholder:text-[#111111]/40" />
              </div>
              
              {/* Email */}
              <div className="flex flex-col gap-2">
                <label htmlFor="email" className="text-[11px] font-bold text-[#111111]/60 uppercase tracking-[0.15em] font-sans pl-2">Email Address *</label>
                <input required type="email" id="email" name="email" placeholder="Enter your email" className="w-full h-[64px] px-6 rounded-[24px] bg-[#F3F4F6] border border-transparent focus:border-[#111111] focus:bg-white outline-none font-sans text-[15px] font-medium transition-all placeholder:text-[#111111]/40" />
              </div>

              {/* Phone */}
              <div className="flex flex-col gap-2">
                <label htmlFor="phone" className="text-[11px] font-bold text-[#111111]/60 uppercase tracking-[0.15em] font-sans pl-2">Phone Number</label>
                <input type="tel" id="phone" name="phone" placeholder="Enter your number" className="w-full h-[64px] px-6 rounded-[24px] bg-[#F3F4F6] border border-transparent focus:border-[#111111] focus:bg-white outline-none font-sans text-[15px] font-medium transition-all placeholder:text-[#111111]/40" />
              </div>

              {/* Service Dropdown */}
              <div className="flex flex-col gap-2">
                <label htmlFor="service" className="text-[11px] font-bold text-[#111111]/60 uppercase tracking-[0.15em] font-sans pl-2">Service Interested In *</label>
                <div className="relative">
                  <select required id="service" name="service" defaultValue="" className="w-full h-[64px] px-6 rounded-[24px] bg-[#F3F4F6] border border-transparent focus:border-[#111111] focus:bg-white outline-none font-sans text-[15px] font-medium transition-all appearance-none cursor-pointer text-[#111111]" style={{ backgroundImage: 'url("data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23111111%22%20stroke-width%3D%222.5%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E")', backgroundRepeat: 'no-repeat', backgroundPosition: 'right 1.5rem center', backgroundSize: '1.2em' }}>
              ...
              {/* Message */}
              <div className="flex flex-col gap-2">
                <label htmlFor="message" className="text-[11px] font-bold text-[#111111]/60 uppercase tracking-[0.15em] font-sans pl-2">Message *</label>
                <textarea required id="message" name="message" placeholder="Enter your message" className="w-full min-h-[180px] p-6 rounded-[24px] bg-[#F3F4F6] border border-transparent focus:border-[#111111] focus:bg-white outline-none font-sans text-[15px] font-medium transition-all resize-none placeholder:text-[#111111]/40"></textarea>
              </div>
              ...
              <button 
                ...
                className="w-full h-[64px] bg-[#111111] text-white rounded-[24px] font-black text-[16px] flex items-center justify-center gap-3 hover:bg-[#222222] transition-all shadow-xl active:scale-[0.98] disabled:opacity-70 font-sans mt-4"
              >
                {status === "idle" && (
                  <>
