      ...
      <nav className="fixed top-0 w-full z-50 bg-white border-b border-gray-100">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 h-20 flex items-center justify-between">
          ...
          <Link 
            ...
            target="_blank"
            className="hidden lg:flex items-center gap-2 bg-[#25D366] text-white px-6 py-2.5 rounded-full text-[14px] font-bold hover:brightness-110 transition-all shadow-md shadow-green-500/20"
          >
