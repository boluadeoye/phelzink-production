...
const Footer = () => {
  ...
  return (
    <footer className="bg-black pt-24 pb-12 text-white font-sans">
      <div className="max-w-[1440px] mx-auto px-8 md:px-16">
        
        {/* 4-COLUMN TOP-ALIGNED GRID */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 items-start mb-32">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[#808080] text-[15px] leading-[1.6] max-w-[260px] font-medium">
          ...
          <div className="flex flex-col">
            <h4 className="text-[14px] font-[900] uppercase tracking-[0.25em] mb-10 text-white leading-none lg:mt-[12px]">
              Quick Links
            </h4>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-6 text-[#808080] text-[15px] font-medium mb-12">
              ...
              <li className="flex items-start gap-4">
                <MapPin size={18} className="text-[#22C55E] mt-1 shrink-0" />
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <Link key={i} href={social.url} target="_blank" className="w-11 h-11 rounded-full border border-white/10 flex items-center justify-center text-[#808080] hover:text-white hover:border-white transition-all">
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-white text-[12px] font-[900] uppercase tracking-[0.4em]">
