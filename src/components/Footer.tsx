      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col">
            <div className="relative w-24 h-24 mb-8">
              <Image src="https://res.cloudinary.com/dwbjb3svx/image/upload/v1776962525/blog_assets/tzasw1vrukgoz1proi8j.png" alt="Logo" fill className="object-contain" />
            </div>
            <p className="text-white/80 text-[15px] leading-relaxed max-w-[300px] font-sans">
          ...
          <div>
            <h4 className="text-xl font-bold mb-8 font-sans">Contact Us</h4>
            ...
            <div className="flex items-center gap-6">
              <Link href={whatsappUrl} target="_blank" className="hover:text-emerald transition-colors">
              ...
              <Link href={instagramUrl} target="_blank" className="hover:text-emerald transition-colors">
              ...
              <Link href={youtubeUrl} target="_blank" className="hover:text-emerald transition-colors">
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-white/40 text-[11px] font-bold font-sans uppercase tracking-[0.2em]">
            <Link href="https://staymedia.ng/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors underline underline-offset-4 decoration-white/10 hover:decoration-white">Designed & Developed by STAY MEDIA</Link>
          </div>
        </div>
      </div>
    </footer>
