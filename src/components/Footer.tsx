  ...
  return (
    <footer className="bg-black pt-24 pb-10 text-white font-sans">
      <div className="max-w-[1440px] mx-auto px-8 md:px-16">
        ...
        {/* THE STRICT 2x2 MATRIX GRID */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-32 gap-y-20 mb-24">
          
          {/* CELL 1: Logo & Description */}
          <div className="flex flex-col">
            ...
            <p className="text-[#808080] text-[15px] leading-[1.6] max-w-[340px] font-medium">
          ...
          {/* CELL 2: Quick Links */}
          <div className="flex flex-col">
            <h4 className="text-[14px] font-[900] uppercase tracking-[0.3em] mb-10 text-white">
              Quick Links
            </h4>
          ...
          {/* CELL 3: Services (Locked to same row as Contact Us) */}
          <div className="flex flex-col">
            <h4 className="text-[14px] font-[900] uppercase tracking-[0.3em] mb-10 text-white">
              Services
            </h4>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <Link key={i} href={social.url} target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-[#808080] hover:text-white hover:border-white transition-all">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-white text-[11px] font-[900] uppercase tracking-[0.5em]">
