...
const Footer = () => {
  ...
  return (
    <footer className="bg-black pt-24 pb-10 text-white border-t border-white/5">
      <div className="max-w-[1440px] mx-auto px-8 md:px-16">

        {/* THE 4-COLUMN INDUSTRIAL GRID */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          
          {/* COLUMN 1: The Stamped Logo */}
          <div className="flex flex-col items-start">
            <div className="relative w-20 h-20 mb-8 transition-transform duration-500 rotate-[-15deg] hover:rotate-0 origin-center">
              <Image 
            ...
            <p className="text-white/60 text-[14px] leading-relaxed max-w-[280px] font-medium">
          ...
          <div>
            <h4 className="text-[13px] font-bold uppercase tracking-[0.2em] mb-8 text-white/90">Quick Links</h4>
          ...
          {/* COLUMN 3: Services */}
          <div>
            <h4 className="text-[13px] font-bold uppercase tracking-[0.2em] mb-8 text-white/90">Services</h4>
            <ul className="space-y-4 text-white/50 text-[14px]">
          ...
          <div>
            <h4 className="text-[13px] font-bold uppercase tracking-[0.2em] mb-8 text-white/90">Contact Us</h4>
            <ul className="space-y-5 text-white/50 text-[14px] mb-10">
              <li className="flex items-center gap-3 hover:text-white transition-colors">
                <Mail size={18} strokeWidth={1.5} className="text-emerald" />
                <span>Phelzink@gmail.com</span>
              </li>
              <li className="flex items-center gap-3 hover:text-white transition-colors">
                <Phone size={18} strokeWidth={1.5} className="text-emerald" />
              ...
              <li className="flex items-start gap-3 hover:text-white transition-colors">
                <MapPin size={18} strokeWidth={1.5} className="mt-1 text-emerald" />
            ...
            <div className="flex items-center gap-5">
              <Link href={whatsappUrl} target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-[#25D366] hover:border-[#25D366]/30 transition-all duration-300">
              ...
              <Link href={instagramUrl} target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:border-white/30 transition-all duration-300">
              ...
              <Link href={linkedinUrl} target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-[#0A66C2] hover:border-[#0A66C2]/30 transition-all duration-300">
