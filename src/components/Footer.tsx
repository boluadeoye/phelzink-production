    ...
    <footer className="bg-black pt-24 pb-12 text-white border-t border-white/5">
      <div className="max-w-[1280px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          {/* Column 1: Brand with Circular Logo */}
          ...
          <div>
            ...
            <ul className="space-y-4 font-sans text-white/50 text-[16px]">
          ...
          <div>
            ...
            <ul className="space-y-5 font-sans text-white/50 text-[15px] mb-10">
            ...
            <div className="flex items-center gap-6">
              <Link href="https://wa.me/2348125821771" target="_blank" className="text-white/60 hover:text-emerald transition-colors">
              ...
              <Link href="https://www.youtube.com/@PelumiOgunyemi-h4g" target="_blank" className="text-white/60 hover:text-white transition-colors">
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-white/30 text-[11px] font-bold font-sans uppercase tracking-[0.2em]">
            <Link 
              href="https://staymedia.ng/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="hover:text-white transition-colors underline underline-offset-4 decoration-white/10 hover:decoration-white"
            >
