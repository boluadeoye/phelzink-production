    ...
    <footer className="bg-black text-white pt-20 md:pt-28 pb-10 font-sans overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2.5fr] gap-16 lg:gap-24 mb-24 md:mb-32">
          ...
          {/* COLUMN 1: BRAND ANCHOR (LOGOS STRIPPED FOR DIAGNOSIS) */}
          <div className="flex flex-col items-start">
            <div className="w-full h-20 mb-10 border border-dashed border-white/10 flex items-center justify-center">
              <span className="text-[10px] uppercase tracking-widest opacity-20">Logo Area Stripped</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div className="flex flex-col">
              ...
              <ul className="space-y-6 text-[#808080] text-[14px] font-medium mb-12">
                <li className="flex items-center gap-4"><Mail size={16} className="text-[#22C55E]" /> Phelzink@gmail.com</li>
                <li className="flex items-center gap-4"><Phone size={16} className="text-[#22C55E]" /> +234 707 258 0692</li>
                <li className="flex items-center gap-4"><Phone size={16} className="text-[#22C55E]" /> +234 812 582 1771</li>
                <li className="flex items-start gap-4"><MapPin size={16} className="text-[#22C55E] mt-1" /> 24, Oguntolu street, Shomolu, Lagos</li>
              </ul>
              
              {/* Social Icons (Hardened SVGs) */}
              <div className="flex items-center gap-4 pt-4 border-t border-white/5">
                <Link href={whatsappUrl} target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-[#808080] hover:text-white transition-all">
                ...
                <Link href={instagramUrl} target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-[#808080] hover:text-white transition-all">
                ...
                <Link href={linkedinUrl} target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-[#808080] hover:text-white transition-all">
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[#4D4D4D] text-[12px] font-medium tracking-wide">© 2026 Phelzink Production. All rights reserved.</p>
          <div className="text-white text-[10px] font-[900] uppercase tracking-[0.4em] opacity-80">
            <Link href="https://staymedia.ng/" target="_blank">DESIGNED & DEVELOPED BY STAY MEDIA</Link>
          </div>
        </div>
      </div>
    </footer>
