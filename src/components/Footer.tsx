      ...
      <div className="max-w-[1440px] mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_2.8fr] gap-16 lg:gap-24 mb-20 md:mb-28">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="relative grid place-items-center w-32 h-32 md:w-44 md:h-44 mb-8 -ml-4 md:-ml-6">
        ...
        {/* BOTTOM BAR: Prominence & Mobile Line Lock */}
