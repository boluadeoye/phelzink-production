      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div>
            ...
            {/* Social Icons Row with YouTube */}
            <div className="flex items-center gap-5 mt-8">
              <Link href="https://wa.me/2348125821771" target="_blank" className="text-white hover:text-emerald transition-colors">
        ...
        {/* Bottom Bar with Functional STAY MEDIA Link */}
